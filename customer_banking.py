...
def main():
    ...
    print(f"The interest earned is: $", format(updated_savings_balance, ',.2f'))
    print(f"The updated balance is: $", format(interest_earned, ',.2f'))
    print(f"Length of Savings Account is: ", format(savings_maturity), 'months.')
    ...
    print(f"The interest earned is: $", format(cd_interest_earned, ',.2f'))
    print(f"The updated balance is: $", format(updated_cd_balance, ',.2f'))
    print(f"Length of CD Account is:", format(cd_maturity), 'months.')
